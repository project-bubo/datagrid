...
class DataGrid extends Nette\Application\UI\Control implements \ArrayAccess {
    ...
    public function addImageColumn($name, $caption = NULL) {
        return $this[$name] = new Columns\ImageColumn($name, $caption);
    }
    ...
    protected function createComponentJs() {
        ...
        $jsLoader->tempUri = $this->presenter->basePath . 'mfu';
        $jsLoader->tempPath = WWW_DIR . '/mfu';
    ...
    protected function createComponentCss() {
        ...
        $cssLoader->tempUri = $this->presenter->basePath . 'mfu';
        $cssLoader->tempPath = WWW_DIR . '/mfu';
